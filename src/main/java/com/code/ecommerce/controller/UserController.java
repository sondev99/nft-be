...
public class UserController {
    ...
    public ResponseEntity<ResponseMessage> getCurrentUser(@RequestHeader("Authorization") String token) {
        return ResponseEntity
                ...
                .body(ResponseMessage.<UserDto>builder().code(200).message("Get current user successful !!!").data(userService.getCurrentUser(token)).build());
    }
    ...
    public ResponseEntity<ResponseMessage> getById(@PathVariable String id) {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(ResponseMessage.<UserDto>builder().code(200).message("Get user successful !!!").data(userService.getUserById(id)).build());
    ...
    public ResponseEntity<ResponseMessage> updateUserInfo(@RequestBody Map<String, Object> fields, @PathVariable String id) {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(ResponseMessage.<UserDto>builder().code(200).message("Update user information successful !!!").data(userService.updateUser(fields, id)).build());
    ...
    public ResponseEntity<ResponseMessage> updateUserAvatar(@RequestParam MultipartFile file, @PathVariable String id) {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(ResponseMessage.<String>builder().code(200).message("Update user avatar successful !!!").data(userService.updateAvatar(file, id)).build());
    ...
    public ResponseEntity<ResponseMessage> getUserWithCondition(@RequestParam(name = "searchText") String searchText,
        ...
        return ResponseEntity
                .status(HttpStatus.OK)
                        .
                body(ResponseMessage.<PagingData>builder().code(200).message("Update user information successful !!!").data(userService.getUsers(searchText, offset, pageSize, sortStr)).build());
    ...
    public ResponseEntity<ResponseMessage> getAllUsers() {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(ResponseMessage.<List<UserDto>>builder().code(200).message("Update user information successful !!!").data(userService.getAllUser()).build());
    ...
    public ResponseEntity<ResponseMessage> deleteUser(@PathVariable String id) {
        return ResponseEntity
                ...
                .body(ResponseMessage.<String>builder().code(200).message("Delete user successful !!!").data(userService.deleteUser(id)).build());
