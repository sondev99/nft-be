...
public class SummaryController {
    private final SummaryService sumaryService;
    ...
    public ResponseEntity<ResponseMessage> summary(@RequestParam @Nullable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime startDate,
            ...
            return ResponseEntity
                    ...
                    .body(ResponseMessage.<SummaryResponse>builder().code(200).message("Create summary successful !!!").data(sumaryService.getSummary(startDate, endDate)).build());
